  ...
  window.onscroll = function () {
    ...
    if(logo.length) {
      ...
      if (ud_header.classList.contains('sticky-header')) {
        document.querySelector(".header-logo").src = '/assets/logo/maya-logo-1.png';
      } else {
        document.querySelector('.header-logo').src = '/assets/logo/maya-logo-1.png'; // white svg logo gelecek logo-white.svg
      }
    }
